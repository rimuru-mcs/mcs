...
RULE_BOOL(Custom, PermanentServerBuffsEnabled, false, "Enable automatic MSR permanent server buffs on zone/login after global buff spell rows and runtime behavior are verified.")
